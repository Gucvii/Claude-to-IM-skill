...
import { initBridgeContext } from '@gucvii/claude-to-im/src/lib/bridge/context.js';
import * as bridgeManager from '@gucvii/claude-to-im/src/lib/bridge/bridge-manager.js';
// Side-effect import to trigger adapter self-registration
import '@gucvii/claude-to-im/src/lib/bridge/adapters/index.js';
import './adapters/weixin-adapter.js';

import type { LLMProvider } from '@gucvii/claude-to-im/src/lib/bridge/host.js';
